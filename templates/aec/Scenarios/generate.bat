...
"C:\Program Files (x86)\CS_suite_5\project\Scenarios\generator.exe" --verbose=255 --target=%target_dir% --recognition=scenario_level.recognition  --template=anthrome --decode=decode --ultimates=ultimates
